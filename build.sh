...
cmake -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -DOpenCV_DIR=${OpenCV_DIR} -DANDROID_ABI="arm64-v8a" -DANDROID_NDK_ABI_NAME="arm64-v8a" ..
make 
popd
